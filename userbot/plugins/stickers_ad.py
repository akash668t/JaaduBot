...
async def _(event):
    ...
    packshortname = f"Jaadu_ke_adult_stickers"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        if userid == 719877937:
            packshortname = "Jaadu_Adult_Animated"
        else:
            packshortname = f"Jaadu_Adult_nimated" # format: Uni_Borg_userid
